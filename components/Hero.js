    ...
    return (
        <div className="relative w-full h-screen">
            ...
            <div className="absolute z-20 w-full text-center top-1/3">
                <h1 className="text-sm font-extrabold text-white font-body sm:text-lg md:text-8xl">I'm An Doan.</h1>
                <h3 className="text-3xl font-semibold text-gray-300 font-body">I'm a Brisbane based <span className="font-bold text-white">React Developer</span></h3>
                <h3 className="text-3xl font-semibold text-gray-300 font-body">Fullstack Developer and Tech Enthusiast, Learner</h3>
